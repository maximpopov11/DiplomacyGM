...
def player(discription: str="run this command"):
    def player_check(function: Callable[[Player | None, commands.Context, Manager], tuple[str, str | None]]) -> Callable[[commands.Context, Manager], tuple[str, str | None]]:
...
def gm(discription: str="run this command"):
    def gm_check(function: Callable[[commands.Context, Manager], tuple[str, str | None]]) -> Callable[[commands.Context, Manager], tuple[str, str | None]]:
